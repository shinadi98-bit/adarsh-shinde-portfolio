...
export const profileTracks = [
  {
    ...
    selectorCopy: "Valuation, stock research, market analysis, Bloomberg, and AI-enabled sentiment research.",
    ctaLabel: "View research profile",
    bestFor: ["Equity Research", "Investment Analysis", "Valuation", "Market Research"],
    roles: ["Equity Research Analyst", "Investment Analyst", "Valuation Analyst", "Research Associate"],
    resumeId: "investment-research",
    projectIds: ["drivers"],
    experienceIds: ["omega"],
    skillGroups: ["Finance and Research"],
    color: "cyan",
  },
  {
    id: "sap-finance",
    ...
    selectorCopy: "SAP FI issue resolution, UAT, go-live support, finance processes, and ERP delivery.",
    ctaLabel: "View SAP profile",
    bestFor: ["SAP FI", "SAP FICO", "ERP Finance", "Finance Systems"],
    roles: ["SAP FI Consultant", "SAP FICO Consultant", "ERP Finance Consultant", "Finance Systems Analyst"],
    resumeId: "sap-fico",
    projectIds: [] as string[],
    experienceIds: ["hcl"],
    skillGroups: ["Finance Systems and Compliance"],
    color: "teal",
  },
  {
    id: "core-finance",
    ...
    selectorCopy: "Accounts finalization, GST, TDS, ROC filings, reconciliations, MIS, and reporting.",
    ctaLabel: "View core finance profile",
    bestFor: ["Finance Analyst", "FP&A", "Accounts", "MIS", "Tax", "Compliance"],
    roles: ["Finance Analyst", "FP&A Analyst", "Tax and Compliance", "Finance Operations"],
    resumeId: "core-finance",
    projectIds: [] as string[],
    experienceIds: ["lahoti"],
    skillGroups: ["Finance and Research", "Finance Systems and Compliance"],
    color: "gold",
  },
  {
    id: "finance-ai",
    ...
    selectorCopy: "AI-assisted finance workflows, LLM sentiment research, automation projects, and digital builds.",
    ctaLabel: "View AI finance profile",
    bestFor: ["Fintech Analyst", "AI Finance", "Finance Automation", "Product Analyst"],
    roles: ["Fintech Analyst", "AI Finance Analyst", "Business Analyst", "Product Analyst"],
    resumeId: "finance-ai",
    projectIds: ["drivers", "algo-trading", "exampack"],
    experienceIds: ["omega"],
    skillGroups: ["AI and Workflow Automation", "Tools and Technology"],
    color: "violet",
  },
];
